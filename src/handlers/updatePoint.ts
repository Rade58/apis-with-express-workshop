 ...
 */
export const getUpdatePoints: Handler = async (req, res, next) => {
  try {
...
export const getUpdatePoint: Handler = async (req, res, next) => {
  try {
    //
    const userId = req.user.id;
 ...
 */
export const createUpdatePoint: Handler = async (req, res, next) => {
  try {
    //
    const userId = req.user.id;
...
//
//
export const updateUpdatePoint: Handler = async (req, res, next) => {
  try {
    const userId = req.user.id;
    const updatePointId = req.params.id;
...
export const deleteUpdatePoint: Handler = async (req, res, next) => {
  try {
    //
    const userId = req.user.id;
    const updatePointId = req.params.id;

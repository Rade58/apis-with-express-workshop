 ...
 */
export const getUpdates: Handler = async (req, res, next) => {
  try {
 ...
 */
export const getUpdate: Handler = async (req, res, next) => {
  try {
    const userId = req.user.id;
 ...
 */
export const createUpdate: Handler = async (req, res, next) => {
  try {
    const userId = req.user.id;
 ...
 */
export const updateUpdate: Handler = async (req, res, next) => {
  try {
    const userId = req.user.id;
    const updateId = req.params.id;
 ...
 */
export const deleteUpdate: Handler = async (req, res, next) => {
  try {
    const userId = req.user.id;
    const updateId = req.params.id;
